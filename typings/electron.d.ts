...
declare namespace Electron {
  ...
  interface App extends EventEmitter {
    ...
    getFileIcon(
      ...
      callback: (error: Error, icon: NativeImage) => void,
    ): void;
    /**
     * Fetches a path's associated icon. On Windows, there a 2 kinds of icons: On Linux
     * and macOS, icons depend on the application associated with file mime type.
  ...
  interface ContentTracing extends EventEmitter {
    ...
    captureMonitoringSnapshot(
      ...
      callback: (resultFilePath: string) => void,
    ): void;
    /**
     ...
     */
    getTraceBufferUsage(
      callback: (value: number, percentage: number) => void,
    ): void;
    /**
  ...
  interface DesktopCapturer extends EventEmitter {
    ...
    getSources(
      ...
      callback: (error: Error, sources: DesktopCapturerSource[]) => void,
    ): void;
  }
  ...
  interface InAppPurchase extends EventEmitter {
    ...
    purchaseProduct(
      productID: string,
      quantity?: number,
      callback?: (isProductValid: boolean) => void,
    ): void;
  }
  ...
  interface Protocol extends EventEmitter {
    ...
    interceptStreamProtocol(
      ...
      handler: (
        ...
        callback: (stream?: ReadableStream | StreamProtocolResponse) => void,
      ) => void,
      completion?: (error: Error) => void,
    ): void;
    /**
    ...
    registerStandardSchemes(
      schemes: string[],
      options?: RegisterStandardSchemesOptions,
    ): void;
    /**
  ...
  interface WebFrame extends EventEmitter {
    ...
    registerURLSchemeAsPrivileged(
      scheme: string,
      options?: RegisterURLSchemeAsPrivilegedOptions,
    ): void;
    /**
  ...
  class WebRequest extends EventEmitter {
     ...
     */
    onBeforeRedirect(
      listener: (details: OnBeforeRedirectDetails) => void,
    ): void;
    /**
     * The listener will be called with listener(details) when a server initiated
     * redirect is about to occur.
     ...
     */
    onCompleted(
      filter: OnCompletedFilter,
      listener: (details: OnCompletedDetails) => void,
    ): void;
    /**
     * The listener will be called with listener(details) when a request is completed.
     */
    ...
    onErrorOccurred(
      ...
      listener: (details: OnErrorOccurredDetails) => void,
    ): void;
    /**
     ...
     */
    onResponseStarted(
      listener: (details: OnResponseStartedDetails) => void,
    ): void;
    /**
     * The listener will be called with listener(details) when first byte of the
     * response body is received. For HTTP requests, this means that the status line
    ...
    onSendHeaders(
      ...
      listener: (details: OnSendHeadersDetails) => void,
    ): void;
    /**
     * The listener will be called with listener(details) just before a request is
     * going to be sent to the server, modifications of previous onBeforeSendHeaders
